...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
   ...
   [_EDWIN] = LAYOUT_JP(
    ...
    [_MOUSE] = LAYOUT_JP(
        ...
        _______, _______, _______, _______, _______, _______, _______, KC_PGUP, KC_MS_U, KC_PGDN, _______, _______, _______,
        _______, LCTL(KC_A), KC_BTN3, KC_BTN2, KC_ACL2, _______, _______, KC_MS_L, KC_MS_D, KC_MS_R, _______, _______, _______, _______,
